...
# ---------------- Header ----------------
st.title("🧭 Finansijska sloboda 360 — V3")
st.markdown(
    '<div class="hero"><b>Od finansijske baze do kompetencije:</b> '
    'imovina → spremnost → tržište → portfolio gap → novi kapital → accelerator → sloboda.</div>',
    unsafe_allow_html=True,
)
st.caption(
...
with tabs[5]:
    ...
    st.download_button(
        ...
        data=xlsx,
        file_name="Financial_Freedom_360_V3_snapshot.xlsx",
